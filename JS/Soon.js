...
const soonData = {
    ...
    zeroProgress: [
        ...
        { name: "spacial rend", confidence: "green" },
        { name: "Sephiroth", confidence: "green" },
        ...
        { name: "macabre", confidence: "orange" },
        { name: "bloodlust", confidence: "red" },
        { name: "silent club", confidence: "red" },
        { name: "electric forest", confidence: "green" },
        { name: "gravity", confidence: "green" },
        { name: "fever dream", confidence: "red" },
        { name: "eternal moment", confidence: "green" },
    ...
    dropped: [
        { name: "Broken Signal", confidence: "orange", note: "88%, 87%x5" },
        { name: "Devil Vortex", confidence: "green", note: "53%x2, 3 runs" },
        { name: "Sleeptalk", confidence: "red", note: "%" },
        { name: "allegiance", confidence: "orange", note: "%" },
        { name: "Biohazard", confidence: "green", note: "2 runs" },
        { name: "New Record", confidence: "orange", note: "2 runs" },
        { name: "Phobos", confidence: "green", note: "55%?" },
        { name: "fish fish godmode", confidence: "green", note: "71%" },
